...
class Network:
    ...
    def calculate_reputation(self, observer_id : str) -> dict:
    ...
    def create_adjacency_matrix(self, id_order) :
    ...
    def get_random_image(self, name):
        ...
        return "https://raw.githubusercontent.com/Empresta-me/Nerwork-Visualization/main/logos/" + str(num) +".png"

    def get_random_message(self, value, seed):
        if value ==1:
            list = [
    ...
    def get_diagram(self, observer : str) -> str:
        # NOTE: this is awful. redo this

        id_order = list(self.nodes.keys())

        reputation_dict = self.calculate_reputation(observer)
        ...
        nodes = []
        links = []
        for idx, name in enumerate(id_order):
            ...
            node = {"name":name,"reputation":rep,"id":idx}
